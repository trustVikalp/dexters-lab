...
vim.schedule(function()
	...
	-- Conform (Prettier-like formatter)
	map(
		{ "n", "v" },
		"<leader>f",
	...
	map("n", "<leader>ha", function()
		load_mod("harpoon", function(harpoon) harpoon:list():add() end)
	end, "Harpoon: Add file")

	map("n", "<leader>hh", function()
		load_mod("harpoon", function(harpoon) harpoon.ui:toggle_quick_menu(harpoon:list()) end)
	end, "Harpoon: Toggle UI")

	map("n", "<leader>h1", function()
		load_mod("harpoon", function(harpoon) harpoon:list():select(1) end)
	end, "Harpoon: Go to file 1")

	map("n", "<leader>h2", function()
		load_mod("harpoon", function(harpoon) harpoon:list():select(2) end)
	end, "Harpoon: Go to file 2")

	map("n", "<leader>h3", function()
		load_mod("harpoon", function(harpoon) harpoon:list():select(3) end)
	end, "Harpoon: Go to file 3")

	map("n", "<leader>h4", function()
		load_mod("harpoon", function(harpoon) harpoon:list():select(4) end)
